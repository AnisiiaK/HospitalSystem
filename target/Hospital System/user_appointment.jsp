                     ...
                     <input type="email" class="form-control" id="exampleInputEmail1"
                        ...
                        <div class="col-md-6">
                            <label for="inputAge" class="form-label">Age</label> <input
                                required type="number" class="form-control" id="inputAge" name="age">
                        </div>

                        <div class="col-md-6">
                            <label for="inputAppointmentDate" class="form-label">Appointment Date</label>
                            <input type="date" class="form-control" required name="appoint_date" id="inputAppointmentDate">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input maxlength="10" required type="number" id="inputPhoneNo" class="form-control" name="phno">
                        </div>

                        <div class="col-md-6">
                            <label for="inputDiseases" class="form-label">Diseases</label> <input
                                required type="text" class="form-control" id="inputDiseases" name="diseases">
                        </div>

                        <div class="col-md-6">
                            <label for="inputDoctor" class="form-label">Doctor</label>
                            <select required class="form-control" id="inputDoctor" name="doct">
